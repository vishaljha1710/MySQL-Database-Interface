        ...
        <div class="card bg-dark text-white" style="border-radius: 1rem;">
          <div class="card-body p-5 text-center">
            ...
            <div class="mb-md-5 mt-md-4 pb-5">
              ...
              <p class="text-white-50 mb-5">Please enter your MySQL credentials</p>
...
<form method="post" action="" >
              ...
              <div class="form-outline form-white mb-4">
                ...
                <label class="form-label" for="password">Password<br><br><a style="color:red"><?php echo $err?></a></label>
              </div>
...
</svg><p class="mb-0">&nbsp;&nbsp;&nbsp;MySQL Database
              </p>
              </div>
