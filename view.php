...
<table class="table">
  <thead class="thead-dark">
    <tr>
    <th scope="col" width="100" >SL.NO</th>
      <th scope="col" width="2000" >Tables in "<?php echo "$defaultdatabase";?>"</th>
    </tr>
  </thead>
  <tbody>
    <?php 
    ...
    <tr>
      ...
      <td scope="row"><a href="viewtable.php?database=<?php echo $defaultdatabase?>&tablename=<?php $attribue ="Tables_in_$defaultdatabase";echo $row[$attribue]?>"><?php echo $row[$attribue]?></a></td>
    </tr>
  <?php $number++;}}?>
  </tbody>
</table>
...
>>>>>>> 42e4658c50a69005676b30376aba666e33d368d5
</html>